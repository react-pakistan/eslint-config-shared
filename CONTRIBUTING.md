# Contributing to eslint-shared-config

Love eslint-shared-config and want to help? Thank you so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/react-pakistan/eslint-shared-config/issues) is
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git clone https://github.com/<your-username>/eslint-shared-config.git
    # Navigate to the newly cloned directory
    cd eslint-shared-config
    # Assign the original repo to a remote called "upstream"
    git remote add upstream https://github.com/react-pakistan/eslint-shared-config.git
    ```
...
owners to license your work under the terms of the [MIT License](https://github.com/react-pakistan/eslint-shared-config/blob/master/LICENSE.md).
